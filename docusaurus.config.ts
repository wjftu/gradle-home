...
const config: Config = {
  ...
  projectName: 'Gradle Home', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {to: '/kotlin', label: 'Kotlin', position: 'left'},
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Gradle Home`,
    },
    prism: {
